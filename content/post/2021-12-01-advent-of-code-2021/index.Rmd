...
My second attempt was a 'non-tidy' solution, but part 2 also took too long to run for part 2.
...
Lastly, instead of building out a vector, I decided to just count the number of fish at each state of their birthing countdown.  This make things work nice and quick.

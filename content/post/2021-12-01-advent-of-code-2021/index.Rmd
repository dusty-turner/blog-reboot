...
knitr::opts_chunk$set(message=FALSE, warning=FALSE, paged.print=FALSE, eval=F, cache = T)
```
...
```{r echo=TRUE, message=FALSE, warning=FALSE, paged.print=FALSE, eval = T, cashe = F}
library(tidyverse)
```
...
```{r}
tibble(entry = read_lines("content/post/2021-12-01-advent-of-code-2021/day_8.txt")) %>%

...
Here I grow the string according to the directions, count up all characters, and find the solution.  It works fine for 10 interations.
...
```{r}
data <-
  tibble(loc = read_lines(file = "content/post/2021-12-01-advent-of-code-2021/day_13.txt")) %>%
